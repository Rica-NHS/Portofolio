...
<html>
	...
	<body style="background:#AF01FF">
		...
		Cek terlebih dahulu List Peminjaman (<a href="Lihat_Peminjaman.php">Cek List</a>)
		</br>
		<form action="Input_Persetujuan_Peminjaman.php" method="Post">
		</br> ID Anggota (<a href="Lihat_Anggota.php">Cek Anggota</a>): 
		</br>
		<input type="text" name="ID_anggota" />
		</br> Jumlah yang dipinjam:
		</br>
		...
		</br> ID Pengurus: (<a href="Lihat_Pengurus.php">Cek Pengurus</a>)
		</br>
		<input type="text" name="ID_pengurus" />
		</br>
